...
<body>
	...
	<div class="search-header">
		...
		<div class="result-table form-box">
				...
				$filter_order = "SELECT * FROM `order_list` WHERE Order_ID = '$orderid' AND Cust_Email = '$email';";
				$result = mysqli_query($conn, $filter_order);
				...
				?>
					...
					<tr>
						<form method="POST" action="search_order2.php?action=update">
